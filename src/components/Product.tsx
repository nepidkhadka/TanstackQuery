import { useProduct } from "../hooks/queries/productsQueries";
    ...
    <>
      {
        error && <>
          <div className="min-h-screen flex justify-center items-center bg-green-500">
            <span className="text-white" >Error Occured While Fetching Product Data...</span>
          </div>
        </>
      }
      {
        ...
        <div className="productWrapper p-10">
          <div className="flex flex-col gap-4">
            ...
            <div className="border p-4">
              ...
              <span className="text-xl inline-block my-2 font-semibold">
                Rs. {data && data?.price}
              </span>
